...
import { View, Text, StyleSheet, ScrollView, Image, TouchableOpacity, FlatList, Alert, Share } from 'react-native';
import { useSafeAreaInsets } from 'react-native-safe-area-context';
import { LinearGradient } from 'expo-linear-gradient';
import { 
  ChevronLeft, Music, LogOut, Headphones, 
  Shield, Cloud, Download, Upload, Info
    ...
    <View style={styles.container}>
      ...
      >
        ...
        <View style={styles.section}>
          ...
          <GlassView style={styles.featureContainer}>
            <TouchableOpacity style={styles.featureItem} onPress={() => router.push('/admin')}>
              <View style={[styles.featureIcon, {backgroundColor: 'rgba(255,215,0,0.1)'}]}>
                <Shield color="#FFD700" size={20} />
              </View>
              <Text style={[styles.featureTitle, {flex: 1, marginLeft: 12}]}>Admin Panel</Text>
              <ChevronLeft color="#444" size={20} style={{transform: [{rotate: '180deg'}]}} />
            </TouchableOpacity>
          </GlassView>
        </View>
